            ...
            <Layout {...this.props}>
                <main className="content">
                    <section className="product content__row content__row--full-width">
                        ...
                        <figure className="product__figure">
                            <Picture {...this.props} image={_.get(this.props, 'pageContext.frontmatter.default_exampletext_imagedefault_original_image', null)} alt={_.get(this.props, 'pageContext.frontmatter.title', null)} cssClass={'product__image'} />
                        </figure>
                    </section>
                    {_.get(this.props, 'pageContext.frontmatter.category', null) && ((() => {
